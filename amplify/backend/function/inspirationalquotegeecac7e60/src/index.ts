/* Amplify Params - DO NOT EDIT
	API_INSPIRATIONALQUOTEGE_GRAPHQLAPIIDOUTPUT
	API_INSPIRATIONALQUOTEGE_QUOTEAPPDATATABLE_ARN
	API_INSPIRATIONALQUOTEGE_QUOTEAPPDATATABLE_NAME
	ENV
	REGION
Amplify Params - DO NOT EDIT */
    ...
    async function getRandomQuote(apiURLInput:string) {
        ...
        const svgImage = `
          <svg width="${width}" height="${height}">
              ...
              <text x="${width / 2}" y="${
          height - 10
        }" class="footerStyles">Developed by @Herberthk | Quotes from ZenQuotes.io</text>
          </svg>
        `;
